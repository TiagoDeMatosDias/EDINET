...
_DISCOVERY_EXCLUDED_MODULES = frozenset({"common", "api", "__pycache__"})


def discover_backtesting_modules(
    package_name: str = "src.backtesting",
) -> tuple[str, ...]:
    """Return importable module paths under the backtesting package."""
