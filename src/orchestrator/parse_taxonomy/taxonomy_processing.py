...
_SHARE_METRICS_CONCEPT_QNAMES = (
    ...
    "jpcrp_cor:TotalReturnOnSharePriceIndex",
    "jpcrp_cor:NumberOfSharesConstitutingOneUnit",
    "jpcrp_cor:NumberOfShareholdersNationalAndLocalGovernments",
    "jpcrp_cor:NumberOfShareholdersFinancialInstitutions",
    "jpcrp_cor:NumberOfShareholdersFinancialServiceProviders",
    "jpcrp_cor:NumberOfShareholdersOtherCorporations",
    ...
    "jpcrp_cor:NumberOfShareholdersIndividualsAndOthers",
    "jpcrp_cor:NumberOfShareholdersTotal",
    "jpcrp_cor:PercentageOfShareholdingsNationalAndLocalGovernments",
    "jpcrp_cor:PercentageOfShareholdingsFinancialInstitutions",
    "jpcrp_cor:PercentageOfShareholdingsFinancialServiceProviders",
    "jpcrp_cor:PercentageOfShareholdingsOtherCorporations",
    "jpcrp_cor:PercentageOfShareholdingsForeignersOtherThanIndividuals",
    "jpcrp_cor:PercentageOfShareholdingsForeignIndividuals",
    "jpcrp_cor:PercentageOfShareholdingsIndividualsAndOthers",
